...
AGENTS: dict[str, AgentInfo] = {
    ...
    "diary": AgentInfo(
        ...
        title="Diary Agent",
        description=(
            "Личный дневник внутри бота. Принимает записи, помогает с рефлексией, "
            "анализирует настроение и паттерны. Данные приватны. "
            "НЕ использовать — все дневниковые записи идут в obsidian агент."
        ),
        keywords=(
            "diary", "journal",
        ),
        parallelizable=False,
        enabled=False,  # отключён — obsidian агент заменяет
        needs_critic=False,
    ),
    ...
    "research": AgentInfo(
        ...
        keywords=(
            ...
            "это правда", "верно ли", "проверь факт",
    ...
    "todo": AgentInfo(
        ...
        keywords=(
            ...
            "добавь задачу", "выполнено", "выполни задачу",
    ...
    "obsidian": AgentInfo(
        ...
        description=(
            "Сохраняет информацию в Obsidian vault: дневник, заметки, задачи, "
            "Zettelkasten карточки. Используй когда Сократ хочет что-то запомнить, "
            "сохранить, записать, добавить в список дел или создать заметку. "
            "Также ищет и читает существующие заметки."
        ),
        keywords=(
            # Явные упоминания obsidian/vault
            "obsidian", "vault", "zettel", "база знаний",
            # Сохранение/запись
            "запомни", "сохрани", "запиши", "отметь", "зафиксируй",
            "запиши в дневник", "добавь в заметки", "добавь в знания",
            # Дневник — личные записи о дне
            "сегодня", "вчера", "сегодня был", "сегодня была",
            "устал", "устала", "расстроен", "рад", "счастлив",
            "встретил", "встретился", "поговорил", "чувствую", "настроение",
            "запись в дневник", "дневниковая", "личная запись",
            # Задачи для obsidian
            "нужно купить", "нужно сделать", "не забыть",
            "добавь в список", "список дел",
            # Заметки
            "заметк", "создай заметку", "новая заметка",
            # Поиск
            "найди в obsidian", "что я писал", "список заметок", "статистика vault",
        ),
        needs_critic=False,
        enabled=True,
    ),
