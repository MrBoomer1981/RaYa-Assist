...
AGENTS: dict[str, AgentInfo] = {
    ...
    "research": AgentInfo(
        ...
        description=(
            "Глубокое исследование темы из нескольких источников. Три режима: "
            "research (исследование с нескольких углов, синтез), "
            "fact_check (проверка утверждения — за и против), "
            "synthesis (сравнение подходов, разные мнения). "
            "Использовать когда: 'исследуй', 'правда ли', 'проверь факт', "
            "'что известно о', 'за и против', 'разные мнения', 'сравни подходы'."
        ),
        keywords=(
            "исследуй", "изучи", "найди информацию", "что известно",
            "правда ли", "это правда", "верно ли", "проверь факт",
            "миф или", "на самом деле", "действительно ли",
            "объедини", "сравни подходы", "разные мнения", "за и против",
            "плюсы и минусы", "углублённо", "обзор темы",
        ),
        parallelizable=False,
        needs_critic=True,
        enabled=True,
    ...
    "explain": AgentInfo(
        ...
        title="Explain Agent",
        description=(
            "Объясняет сложные концепции понятным языком, структурирует информацию "
            "и разбивает процессы на шаги. Три режима: explain (объяснение с аналогиями), "
            "structure (упорядочивание информации), breakdown (пошаговая инструкция). "
            "Использовать когда: 'объясни', 'что такое X', 'как работает', 'структурируй', "
            "'разбей на шаги', 'пошагово', 'как понять', 'простыми словами'."
        ),
        keywords=(
            "объясни", "объяснение", "что такое", "как работает", "почему",
            "как понять", "не понимаю", "простыми словами", "как ребёнку",
            "структурируй", "упорядочи", "приведи в порядок", "выдели главное",
            "разбей на шаги", "пошагово", "инструкция", "алгоритм",
            "разложи", "как сделать", "с чего начать",
        ),
        parallelizable=False,
        needs_critic=True,
        enabled=True,
