...
class RayaAgent(BaseAgent):
    ...
    async def _execute(self, ctx: AgentContext) -> AgentResult:
        ...
        # Жёсткое правило имени — не зависит от persona.txt
        system += (
            "\n\nКРИТИЧНО: обращайся к пользователю ТОЛЬКО 'Сократ'. "
            "Никогда не копируй обращение из его сообщения. "
            "Если он написал 'Рай' или любое другое имя — это НЕ его имя. "
            "Его имя всегда Сократ."
        )
