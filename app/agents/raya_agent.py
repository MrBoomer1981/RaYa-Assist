...
def _build_hard_rules(user_name: str) -> str:
    return (
        ...
        "Информацию из поиска излагай своими словами.\n"
        "4. Никаких URL в ответах.\n"
        "5. На вопросы о событиях/миссиях/проектах — ВСЕГДА указывай актуальность данных: "
        "'По данным на [дата из результатов поиска]...' если поиск был, или "
        "'На момент моих знаний (могут быть устаревшими)...' если поиска не было.\n"
        "6. Тон ответа: живой, личный, не формальный. "
