...
- Mermaid-диаграмма если структура сложная и визуал помогает:
  ```mermaid
  graph TD / mindmap / flowchart
  ```
  Используй только когда это реально нагляднее текста.
...
Если процесс сложный с развилками — можешь добавить flowchart:
```mermaid
flowchart TD
    A[Шаг 1] --> B{Условие?}
    B -->|Да| C[Шаг 2а]
